...
function FooterLinks({ items }: { items: NavigationItem[] }) {
  return (
    <div className="rh-footer__links bani-shell-footer__links">
      {items.map((item) => (
        <Link key={item.key} to={item.to} className="rh-footer__link bani-shell-footer__link">
          {item.label}
        </Link>
      ))}
    </div>
...
export default function ShellFooter({ showClientSection = false }: ShellFooterProps) {
  ...
  return (
    <footer className="rh-footer bani-shell-footer">
      <div className="rh-footer__grid bani-shell-footer__grid">
        <section className="bani-shell-footer__column bani-shell-footer__column--brand">
          ...
          <p className="rh-footer__description bani-shell-footer__description">{PLATFORM_BRAND_STATEMENT}</p>
        ...
        <section className="bani-shell-footer__column">
          <div className="rh-footer__section-title bani-shell-footer__section-title">Навигация</div>
          <FooterLinks items={PUBLIC_FOOTER_NAV_ITEMS} />
        </section>

        {showClientSection && (
          <section className="bani-shell-footer__column">
            <div className="rh-footer__section-title bani-shell-footer__section-title">Кабинет клиента</div>
            <FooterLinks items={CLIENT_FOOTER_ACCOUNT_ITEMS} />
          </section>
        )}

        <section className="bani-shell-footer__column">
          <div className="rh-footer__section-title bani-shell-footer__section-title">Поддержка и условия</div>
          <div className="rh-footer__links bani-shell-footer__links">
            <Link to="/terms" className="rh-footer__link bani-shell-footer__link">Условия использования</Link>
            <a href={`mailto:${PLATFORM_CONTACTS.supportEmail}`} className="rh-footer__link bani-shell-footer__link">
              {PLATFORM_CONTACTS.supportEmail}
            </a>
            <a href="tel:+74955552121" className="rh-footer__link bani-shell-footer__link">
              {PLATFORM_CONTACTS.supportPhone}
            </a>
            <a href={supportMessengerLink} className="rh-footer__link bani-shell-footer__link" target="_blank" rel="noreferrer">
      ...
      <div className="rh-footer__bottom bani-shell-footer__bottom">
