...
- [x] GET /api/v1/bathhouses/{id}/gallery — публичная галерея фото от посетителей (paginated)
- [x] Включить preview-фото в ответ карточки бани (первые 4 фото из отзывов)
