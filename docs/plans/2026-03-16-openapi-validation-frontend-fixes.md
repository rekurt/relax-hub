...
- [x] Запустить полную сборку бэкенда: `go build ./...`
- [x] Запустить линтер: `make lint`
- [x] Запустить бэкенд тесты: `go test ./... -v`
- [x] Запустить фронтенд тесты: `cd frontend && npx vitest run`
- [x] Запустить TypeScript проверку: `cd frontend && npx tsc --noEmit`
- [x] Убедиться что все тесты проходят (561/561)
