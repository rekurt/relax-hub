...
- [x] Уведомить автора отзыва о результате модерации (approved/rejected + причина)
- [x] Уведомить владельца бани о новом одобренном отзыве
- [x] Интеграция с NotificationService (если реализован) или простой email
- [x] Написать тесты
- [x] Запустить go test ./... - все тесты должны пройти
