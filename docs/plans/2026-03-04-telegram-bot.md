...
- [ ] /search <город> — поиск бань в городе (inline-кнопки с результатами)
- [ ] /book <id> — начать бронирование бани (пошаговый wizard: дата -> время -> гости -> подтверждение)
- [ ] /mybookings — мои бронирования (список с кнопками управления)
- [ ] /cancel <id> — отменить бронирование
- [ ] /favorites — мое избранное
- [ ] Inline-кнопки (callback_query) для навигации по результатам
- [ ] Написать тесты
- [ ] Запустить go test ./... - все тесты должны пройти
...
- [ ] Inline-режим: @bani_bot <запрос> — поиск бань с inline-результатами
- [ ] Уведомления через бота (если привязан Telegram):
  - Подтверждение/отмена бронирования
  - Напоминание за 24 часа до визита
  - Новый отзыв на баню (для владельцев)
- [ ] Интеграция с NotificationService: добавить канал "telegram"
- [ ] Написать тесты
- [ ] Запустить go test ./... - все тесты должны пройти
