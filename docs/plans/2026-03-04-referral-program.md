...
- [ ] При регистрации: если указан referral_code, создать Referral запись
- [ ] При первом бронировании: начислить бонус обоим (configurable: default 500 руб)
- [ ] При бронировании: возможность оплатить реферальными бонусами (частично)
- [ ] Написать тесты
- [ ] Запустить go test ./... - все тесты должны пройти
