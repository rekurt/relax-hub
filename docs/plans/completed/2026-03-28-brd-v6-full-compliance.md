...
- [x] Update CLAUDE.md with new subsystems (saved cards, webhooks, PMS, FAQ bot, admin sub-roles, bank reconciliation)
- [x] Update swagger annotations for all new endpoints, run `make swagger`
