...
- [x] Получить список уведомлений (auth required)
- [x] Пометить как прочитанное
- [x] Получить/обновить настройки уведомлений
- [x] Получить кол-во непрочитанных
...
- [x] Получить данные бани по API key
- [x] Получить доступные слоты
- [x] Создать бронирование через виджет
...
- [x] Все новые hurl-файлы синтаксически корректны (hurl --check)
- [x] .claudeignore создан и корректен
- [x] Отчет об архитектуре полный и структурированный
- [x] go build ./... проходит без ошибок
- [x] go test ./... проходит без ошибок

### Task 10: Update documentation

- [x] Обновить CLAUDE.md если внутренние паттерны изменились
