...
- [x] Ежедневная агрегация в 02:00: подсчет views, bookings, revenue за прошлый день
- [x] Еженедельная очистка старых записей BathhouseView (хранить 90 дней детальных)
- [x] Интеграция с Uber fx lifecycle
- [x] Написать тесты
- [x] Запустить go test ./... - все тесты должны пройти
