...
- [x] Добавить поле PromoCode в запрос создания бронирования
- [x] При создании бронирования: если указан промокод — валидировать, рассчитать скидку, сохранить PromoUsage
- [x] В ответе бронирования отображать original_price и discount_amount
- [x] Написать тесты
- [x] Запустить go test ./... - все тесты должны пройти
