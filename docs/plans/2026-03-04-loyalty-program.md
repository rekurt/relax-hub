...
- [ ] При complete бронирования — начислить баллы, пересчитать уровень
- [ ] При создании бронирования — возможность оплатить баллами (частично)
- [ ] В ответе бронирования: earned_points, loyalty_discount
- [ ] Написать тесты
