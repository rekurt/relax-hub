...
func newTestScheduler(redisClient *redis.Client) *CronScheduler {
	...
	return NewCronScheduler(cfg, log, mockSvc, mockRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, redisClient, nil, nil, nil, nil)
}
...
func TestStart_CronDisabled(t *testing.T) {
	...
	mockSvc := &MockAnalyticsService{}
	mockRepo := mock.NewAnalyticsRepo()
	cs := NewCronScheduler(cfg, log, mockSvc, mockRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
