...
func newTestWalletCronScheduler(notifSvc *mockNotificationService, walletSvc service.WalletService, walletRepo *mock.WalletRepo) *CronScheduler {
	...
	return NewCronScheduler(&config.Config{}, log, mockAnalyticsSvc, mockAnalyticsRepo, nil, nil, notifSvc, nil, walletSvc, walletRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
}
...
func TestHandleBonusExpiryNotify_Deduplication(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log, mockAnalyticsSvc, mockAnalyticsRepo,
		nil, nil, notifSvc, nil, walletSvc, walletRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, redisClient, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
