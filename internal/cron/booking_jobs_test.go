...
func newTestReminderScheduler(notifSvc *mockNotificationService, bookingSvc service.BookingService, redisClient *redis.Client) *CronScheduler {
	...
	return NewCronScheduler(&config.Config{}, log, mockAnalyticsSvc, mockAnalyticsRepo, nil, nil, notifSvc, nil, nil, nil, nil, nil, nil, bookingSvc, nil, nil, nil, nil, nil, nil, nil, redisClient)
}
