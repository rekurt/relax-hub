...
func TestHandleSubscriptionExpiryNotify(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log, mockAnalyticsSvc, mockAnalyticsRepo, subRepo, promoRepo, notifSvc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	require.NoError(t, cs.subscriptionExpiryNotify(context.Background()))
...
func TestHandleExpiredSubscriptionUpdate(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log, mockAnalyticsSvc, mockAnalyticsRepo, subRepo, promoRepo, notifSvc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	require.NoError(t, cs.expiredSubscriptionUpdate(context.Background()))
...
func TestHandlePromoDeactivation(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log, mockAnalyticsSvc, mockAnalyticsRepo, subRepo, promoRepo, notifSvc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	require.NoError(t, cs.promoDeactivation(context.Background()))
