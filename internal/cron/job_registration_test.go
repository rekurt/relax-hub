...
func TestTicketJobs_AutoEscalation(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log,
		&MockAnalyticsService{}, mock.NewAnalyticsRepo(),
		nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, mockTicketSvc, nil, nil, nil,
	)
...
func TestEscrowJob_ProcessMatured(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log,
		&MockAnalyticsService{}, mock.NewAnalyticsRepo(),
		nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, mockEscrowSvc, nil, nil, nil, nil, nil, nil,
	)
...
func TestReviewJobs_PlatformAverageRefresh(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log,
		&MockAnalyticsService{}, mock.NewAnalyticsRepo(),
		nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, mockReviewSvc, nil, nil, nil, nil, nil,
	)
...
func TestAutoScenarioJob(t *testing.T) {
	...
	cs := NewCronScheduler(&config.Config{}, log,
		&MockAnalyticsService{}, mock.NewAnalyticsRepo(),
		nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, mockScenarioSvc, nil, nil, nil, nil,
	)
