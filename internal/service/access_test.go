...
func (n *noopNotifService) GetEventPreferences(_ context.Context, _ uuid.UUID) ([]domain.NotificationEventPreference, error) {
	return nil, nil
}

func (n *noopNotifService) UpdateEventPreferences(_ context.Context, _ uuid.UUID, _ []domain.NotificationEventPreference) error {
	return nil
}
...
func (n *noopPaymentService) RefundPayment(_ context.Context, _ uuid.UUID, _ bool, _ string, _ domain.CancellationPolicy) error {
	return nil
}
func (n *noopPaymentService) AdminRefund(_ context.Context, _ uuid.UUID, _ uuid.UUID, _ int64, _ string, _ string) error {
	return nil
}
