...
func newTestOAuthService(userRepo *mock.UserRepo, socialRepo *mock.SocialAccountRepo, providers map[domain.OAuthProvider]auth.OAuthProvider) service.OAuthService {
	return service.NewOAuthServiceWithProviders(
		userRepo, socialRepo, providers,
...
func TestOAuthService_GetOAuthURL_InvalidProvider(t *testing.T) {
	userRepo := mock.NewUserRepo()
	socialRepo := mock.NewSocialAccountRepo()
	svc := newTestOAuthService(userRepo, socialRepo, nil)
...
func TestOAuthService_OAuthCallback_ReturningUser(t *testing.T) {
	...
	user, token, err := svc.OAuthCallback(context.Background(), domain.OAuthProviderGoogle, "test-code")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestOAuthService_OAuthCallback_BlockedUser(t *testing.T) {
	...
	_, _, err := svc.OAuthCallback(context.Background(), domain.OAuthProviderVK, "test-code")
...
func TestOAuthService_OAuthCallback_ExistingEmailLinksAccount(t *testing.T) {
	...
	user, _, err := svc.OAuthCallback(context.Background(), domain.OAuthProviderYandex, "test-code")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestOAuthService_OAuthCallback_ExchangeError(t *testing.T) {
	...
	_, _, err := svc.OAuthCallback(context.Background(), domain.OAuthProviderVK, "bad-code")
	if err == nil {
