...
func TestBathhouseHandler_Search(t *testing.T) {
	...
	h := handler.NewBathhouseHandler(bhSvc, nil, nil, nil, nil, nil, nil, nil)
...
func TestBathhouseHandler_Create_ForbiddenForClient(t *testing.T) {
	...
	h := handler.NewBathhouseHandler(nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestBathhouseHandler_GetAvailableSlots(t *testing.T) {
	...
	h := handler.NewBathhouseHandler(nil, bookingSvc, nil, nil, nil, nil, nil, nil)
...
func TestBathhouseHandler_MyBathhouses_Representative(t *testing.T) {
	...
	h := handler.NewBathhouseHandler(nil, nil, repSvc, nil, nil, nil, nil, nil)
...
func TestProtectedEndpoints_RequireAuth(t *testing.T) {
	...
	bhH := handler.NewBathhouseHandler(nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestBathhouseHandler_Search_IsFavorite_Authenticated(t *testing.T) {
	...
	h := handler.NewBathhouseHandler(bhSvc, nil, nil, favSvc, nil, nil, nil, nil)
