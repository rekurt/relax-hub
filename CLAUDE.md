...
React SPA for bathhouse owners/representatives: manage bathhouses, bookings, reviews, pricing, promo codes, chat, and settings.
...
├── components/                # Reusable: AppLayout, BathhouseSelector, NotificationBell, ProtectedRoute
├── pages/                     # Feature pages:
│   ├── bathhouses/            # BathhouseList, BathhouseForm (create/edit)
│   ├── bookings/              # BookingList, BookingDetails
│   ├── calendar/              # CalendarPage (weekly view, slot management)
│   ├── chat/                  # ChatPage, ConversationList, MessageArea
│   ├── notifications/         # NotificationList
│   ├── photos/                # PhotoManager (upload, reorder, status)
│   ├── pricing/               # PricingRules (dynamic pricing)
│   ├── promo/                 # PromoList (promo code management)
│   ├── representatives/       # RepresentativeList
│   ├── reviews/               # ReviewList (with response form)
│   ├── settings/              # ProfileSettings
│   ├── subscriptions/         # SubscriptionPage
│   └── widget/                # WidgetSettings
├── stores/                    # Zustand: auth.ts (user/token), bathhouse.ts (selected bathhouse)
├── lib/                       # format.ts, constants.ts, useWebSocketNotifications.ts
